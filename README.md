...
- [Dataset & EDA](#dataset-background)
- [Data Cleaning](#data-cleaning)
- [Architecture (Airflow DAGs)](#airflow-dags-overview)
- [Dashboard & Visualizations](#dashboard-visualizations)
- [Testing Strategy](#testing)
- [CI/CD Workflow](#github-actions-cicd-workflow)
- [Limitations & Future Work](#limitations--future-work)
- [Setup Instructions](#setup-instructions)
- [Engineering Principles](#data-engineering-principles-demonstrated)
...
The goal is to simulate the infrastructure of a real music analytics platform (“Sparkify”) where new listening activity and track data continuously flow through an ETL + ML pipeline, producing fresh recommendations for every user. Specifically, this project addresses the Cold Start problem, which refers to the challenge of making relevant recommendations for users with little or no interaction history, by using a hybrid content-based recommendation model to serve personalized music based on minimal initial input.
...
- **Builds and saves a model artifact** (optimized for fast inference) that contains:
  - The track embedding matrix (NumPy matrix for vectorized operations)
...
Note: The table updates automatically as new recommendations are generated by the Airflow inference DAG. We set the auto-refresh for every one minute.
...
|------------------|---------------------------|
| **Jordan** | Documentation and README<br>Exploratory Data Analysis (EDA)<br>Designed the recommendation model<br>Edited the final video |
| **Aesha** | Documentation and README<br>Data cleaning and transformation<br>Pipeline testing<br>CI/CD testing |
| **Ammy** | Exploratory Data Analysis (EDA)<br>Designed and managed Airflow DAGs<br>Implemented Streamlit dashboard<br>Designed and built the recommendation model<br>Handled communications and organized meetings<br>Edited the final video  |
...
## Video Walkthrough
This [video](https://www.youtube.com/watch?v=6mdhQYfkFKo) demonstrates the full end-to-end execution of the pipeline, from raw data ingestion in Airflow to the final recommendation dashboard in Streamlit.